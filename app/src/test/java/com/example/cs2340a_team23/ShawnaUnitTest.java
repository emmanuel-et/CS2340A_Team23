...
public class ShawnaUnitTest {
    ...
    public void testMoveDown() {
        ...
        int spriteWidth = 50;
        int spriteHeight = 50;
        float[] newPosition = walk.move(initialPosition[0], initialPosition[1], "down", screenWidth, screenHeight, spriteWidth, spriteHeight);
    ...
    public void testMoveLeft() {
        ...
        int spriteWidth = 50;
        int spriteHeight = 50;
        float[] newPosition = walk.move(initialPosition[0], initialPosition[1], "left", screenWidth, screenHeight, spriteWidth, spriteHeight);
