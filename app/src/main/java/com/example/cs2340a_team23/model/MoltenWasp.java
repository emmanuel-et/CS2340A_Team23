...
public class MoltenWasp extends Enemy {
    private String name;
    private ImageView spriteView;
    private int speed;
    private float enemyX;
    private float enemyY;
    public MoltenWasp(float enemyX, float enemyY) {
        this.name = "MoltenWasp";
    ...
    public void createSpriteView(Context context) {
        ...
        int resourceId = context.getResources().getIdentifier("molten_wasp",
