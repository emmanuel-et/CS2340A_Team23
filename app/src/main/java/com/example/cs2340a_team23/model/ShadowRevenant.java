...
public class ShadowRevenant extends Enemy {
    private String name;
    private ImageView spriteView;
    private int speed;
    private float enemyX;
    private float enemyY;
    public ShadowRevenant(float enemyX, float enemyY) {
        this.name = "ShadowRevenant";
    ...
    public void createSpriteView(Context context) {
        ...
        int resourceId = context.getResources().getIdentifier("shadow_revenant",
